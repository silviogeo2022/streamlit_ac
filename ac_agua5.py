...
# -----------------------
# CACHE DOS GEODataFrames
# -----------------------
@st.cache_data
def load_poligonos():
    gdf = gpd.read_file("BD_CONSUMO_AGUA_AC._REV1.shp")
...
if bairros_sel:  # se houver seleção de bairros
...
# -----------------------
# MAPA (somente polígonos)
# -----------------------
st.markdown("### 🗺️ Mapa das Comunidades")

if not df.empty:
    # centraliza no polígono filtrado
    ...
    # Zoom automático para áreas/bairros selecionados
